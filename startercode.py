...
def getPlayerInfo():
    ...
    player3 = input("Enter the third players name: ")
    players = {0:{"roundtotal":0,"gametotal":0,"name":player1},
               1:{"roundtotal":0,"gametotal":0,"name":player2},
               2:{"roundtotal":0,"gametotal":0,"name":player3},
               }
